...
* DYC_SignX509
"""
from ctypes import cast, string_at, c_ubyte, create_string_buffer
...
from .cryptoki import CK_ULONG, CK_MECHANISM_TYPE, DYC_SelfSignX509, DYC_SignX509
...
def dyc_sign_x509(h_session, h_key, x509CA, hash_alg, csr, serial=None, days=365):
    ...
    def _sign_x509():
        return DYC_SignX509(h_session, h_key,
                            cast(x509CA, POINTER(c_ubyte)), CK_ULONG(len(x509CA)),
