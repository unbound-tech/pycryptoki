...
CURVE_SECP256K1 = array('B', curve_list['secp256k1']).tostring()
CURVE_P256 = array('B', curve_list['X9_62_prime256v1(P-256)']).tostring()
CURVE_P384 = array('B', curve_list['secp384r1(P-384)']).tostring()
CURVE_P521 = array('B', curve_list['secp521r1(P-521)']).tostring()
