...
from .defines import (CKA_BASE, CKA_CERTIFICATE_TYPE, CKA_CLASS, CKA_DECRYPT, CKA_DERIVE,
                      ...
                      CKK_DES, CKK_DES2,
                      CKK_DES3, CKK_GENERIC_SECRET, CKK_RC2, CKK_RC4, CKK_RC5,
                      ...
                      CKM_AES_KEY_GEN,
                      CKM_AES_KEY_WRAP, CKM_AES_KEY_WRAP_PAD, CKM_AES_MAC,
                      CKM_AES_MAC_GENERAL,
                      CKM_ARIA_CBC, CKM_ARIA_CBC_ENCRYPT_DATA, CKM_ARIA_CBC_PAD,
                      CKM_ARIA_ECB,
                      CKM_ARIA_ECB_ENCRYPT_DATA, CKM_ARIA_KEY_GEN, CKM_ARIA_MAC,
                      CKM_ARIA_MAC_GENERAL,
                      CKM_BATON_CBC128, CKM_BATON_COUNTER, CKM_BATON_ECB128,
                      CKM_BATON_ECB96,
                      ...
                      CKM_DES3_CBC, CKM_DES3_CBC_ENCRYPT_DATA,
                      CKM_DES3_CBC_PAD,
                      CKM_DES3_CMAC, CKM_DES3_CMAC_GENERAL,
                      CKM_DES3_ECB,
                      ...
                      CKM_DSA_KEY_PAIR_GEN, CKM_DSA_PARAMETER_GEN, CKM_DSA_SHA1,
                      CKM_ECDH1_COFACTOR_DERIVE, CKM_ECDH1_DERIVE, CKM_ECDSA,
                      CKM_ECDSA_KEY_PAIR_GEN, CKM_ECDSA_SHA1,
                      CKM_ECMQV_DERIVE,
                      CKM_EXTRACT_KEY_FROM_KEY, CKM_FASTHASH, CKM_FORTEZZA_TIMESTAMP,
                      CKM_GENERIC_SECRET_KEY_GEN,
                      CKM_HOTP, CKM_HOTP_KEY_GEN, CKM_IDEA_CBC, CKM_IDEA_CBC_PAD,
                      CKM_IDEA_ECB,
                      CKM_IDEA_KEY_GEN, CKM_IDEA_MAC, CKM_IDEA_MAC_GENERAL,
                      CKM_JUNIPER_CBC128, CKM_JUNIPER_COUNTER, CKM_JUNIPER_ECB128,
                      CKM_JUNIPER_KEY_GEN,
                      CKM_JUNIPER_SHUFFLE, CKM_JUNIPER_WRAP,
                      CKM_KEA_KEY_DERIVE, CKM_KEA_KEY_PAIR_GEN,
                      CKM_KEY_WRAP_LYNKS,
                      ...
                      CKM_PBE_SHA1_RC4_40, CKM_PKCS5_PBKD2,
                      ...
                      CKM_RSA_X_509,
                      CKM_SECURID, CKM_SECURID_KEY_GEN,
                      CKM_SHA1_KEY_DERIVATION, CKM_SHA1_RSA_PKCS,
                      CKM_SHA1_RSA_PKCS_PSS,
                      CKM_SHA1_RSA_X9_31, CKM_SHA224, CKM_SHA224_HMAC,
                      ...
                      CKM_SSL3_PRE_MASTER_KEY_GEN, CKM_SSL3_SHA1_MAC,
                      ...
                      CKM_X9_42_MQV_DERIVE, CKM_XOR_BASE_AND_DATA,
...
CKM_RSA_PKCS_KEY_PAIR_GEN_PUBTEMP = {CKA_TOKEN: True,
                                     ...
                                     CKA_VERIFY: True,
                                     CKA_WRAP: True,
                                     CKA_MODULUS_BITS: 2048,  # long 0 - MAX_RSA_KEY_NBITS
...
curve_list = {
    # # [0] OID_secp112r1
    # 'secp112r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x06],
    # # [7] OID_secp112r2
    # 'secp112r2': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x07],
    # # [14] OID_secp128r1
    # 'secp128r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x1C],
    # # [21] OID_secp128r2
    # 'secp128r2': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x1D],
    # # [28] OID_secp160k1
    # 'secp160k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x09],
    # # [35] OID_secp160r1
    # 'secp160r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x08],
    # # [42] OID_secp160r2
    # 'secp160r2': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x1E],
    # # [49] OID_secp192k1
    # 'secp192k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x1F],
    # # [56] OID_secp224k1
    # 'secp224k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x20],
    # # [63] OID_secp224r1
    # 'secp224r1(P-224)': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x21],
    ...
    # P384
    # [77] OID_secp384r1
    'secp384r1(P-384)': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x22],
    # P521
    # [84] OID_secp521r1
    'secp521r1(P-521)': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x23],
    # Bitcoin
    # [70] OID_secp256k1
    ...
    # # [161] OID_sect113r1
    # 'sect113r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x04],
    # # [168] OID_sect113r2
    # 'sect113r2': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x05],
    # # [175] OID_sect131r1
    # 'sect131r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x16],
    # # [182] OID_sect131r2
    # 'sect131r2': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x17],
    # # [189] OID_sect163k1
    # 'sect163k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x01],
    # # [196] OID_sect163r1
    # 'sect163r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x02],
    # # [203] OID_sect163r2
    # 'sect163r2': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x0F],
    # # [210] OID_sect193r1
    # 'sect193r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x18],
    # # [217] OID_sect193r2
    # 'sect193r2': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x19],
    # # [224] OID_sect233k1
    # 'sect233k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x1A],
    # # [231] OID_sect233r1
    # 'sect233r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x1B],
    # # [238] OID_sect239k1
    # 'sect239k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x03],
    # # [245] OID_sect283k1
    # 'sect283k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x10],
    # # [252] OID_sect283r1
    # 'sect283r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x11],
    # # [259] OID_sect409k1
    # 'sect409k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x24],
    # # [266] OID_sect409r1
    # 'sect409r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x25],
    # # [273] OID_sect571k1
    # 'sect571k1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x26],
    # # [280] OID_sect571r1
    # 'sect571r1': [0x06, 0x05, 0x2B, 0x81, 0x04, 0x00, 0x27],
...
CKM_ECDSA_KEY_PAIR_GEN_PUBTEMP = {CKA_TOKEN: True,
                                  CKA_PRIVATE: False,
                                  CKA_VERIFY: True,
                                  CKA_ECDSA_PARAMS: curve_list['X9_62_prime256v1(P-256)'],
...
CKM_ECDH_KEY_PAIR_GEN_PUBTEMP = {CKA_TOKEN: True,
                                 CKA_PRIVATE: False,
                                 CKA_ECDSA_PARAMS: curve_list['X9_62_prime256v1(P-256)'],
                                 CKA_LABEL: b"ECDH Public Key"}
CKM_ECDH_KEY_PAIR_GEN_PRIVTEMP = {CKA_TOKEN: True,
                                  CKA_PRIVATE: True,
                                  CKA_SENSITIVE: True,
                                  CKA_SIGN: False,
                                  CKA_DERIVE: True,
